#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Time-stamp: "2022-11-16 11:17:39 (ywatanabe)"
...
def plot_raster(rips_df, sub, session, i_trial, sd):
    ...
    # filters = torch.ones(len(spike_times_digi_tens), 200)
    synchronous_window_ms = 200
    ...
    recruited_ratio_z = (
        recruited_ratio - (recruited_ratio[:baseline_pts].mean())
    ) / recruited_ratio[:baseline_pts].std()
