#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Time-stamp: "2022-11-24 15:08:13 (ywatanabe)"
...
if __name__ == "__main__":
    ...
    columns = ["i_rip_1", "i_rip_2", "n_common", "correlation", "pval"]
    ...
    for sub in rips_df.subject.unique():
        ...
        for session in tqdm(rips_df_sub.session.unique()):
            ...
            for i_rip_1, i_rip_2 in combinations(np.arange(len(rips_df_session)), 2):
                ...
                columns = ["i_rip1", "i_rip2", "n_common", "correlation", "pval"]
                ...
                corr_df = pd.concat([corr_df, corr_df_tmp])

            mngs.io.save(corr_df, "./tmp/rank_order_corr_df.csv")
