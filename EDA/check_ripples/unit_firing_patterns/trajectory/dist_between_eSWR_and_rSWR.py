#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Time-stamp: "2023-03-15 13:55:54 (ywatanabe)"
...
if __name__ == "__main__":
            ...
            for subject in events_df.subject.unique():
                for session in events_df.session.unique():
                    ...
                    for tgt_bin in range(-10, 11):
                        coords_E = events_df_session[events_df_session.phase == "Encoding"][
                            f"{tgt_bin}"
                        ]
                        coords_R = events_df_session[events_df_session.phase == "Retrieval"][
                            f"{tgt_bin}"
                        ]
                        for cE in coords_E:
                            for cR in coords_R:
    ...
    dtw(np.arange(10), np.arange(10))
    dtw(np.arange(10).reshape(2,-1), np.arange(10).reshape(2,-1))    
