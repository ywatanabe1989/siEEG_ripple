#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Time-stamp: "2023-04-12 14:36:53 (ywatanabe)"
...
#         # i_base, cbs, cbe = 1, "Fixation", "Encoding"
#         #
...
if __name__ == "__main__":
    ...
    LPATH = f"./data/Sub_{subject}/Session_{session}/traj_z_by_session_{roi}.npy"
    ...
    for phase, (ss,ee) in GS_BINS_DICT.items():
        ...
        gs[phase] = np.nanmedian(trajs.transpose(1,0,2)[:,:,ss:ee].reshape(3, -1), axis=-1)
    ...
    mngs.io.save(df, "./res/figs/scatter/repr_traj/session_traj_Subject_06_Session_02.csv")    

    # gs
    df_gs = pd.DataFrame(gs).T
    mngs.io.save(df_gs, "./res/figs/scatter/repr_traj/session_gs_Subject_06_Session_02.csv")    
