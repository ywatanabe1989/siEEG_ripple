#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Time-stamp: "2023-01-04 12:26:27 (ywatanabe)"
...
if __name__ == "__main__":
    ...
    traj_med = np.median(np.stack(trajs, axis=0), axis=0)
    ...
    df["phase"] = None
    df["phase"].iloc[0:5] = "Fixation"
    df["phase"].iloc[5:15] = "Encoding"
    df["phase"].iloc[15:30] = "Maintenance"
    df["phase"].iloc[30:40] = "Retrieval"    

    df = df[["phase", "x", "y", "z"]]

    mngs.io.save(df, "./tmp/figs/line/neural_trajectory/Subject_06_Session_02.csv")
