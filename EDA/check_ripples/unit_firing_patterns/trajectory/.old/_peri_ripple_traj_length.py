#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Time-stamp: "2023-02-26 14:33:02 (ywatanabe)"
...
# Functions
def calc_corr(_data, event, return_raw=False):
    data = _data.copy()
...
def get_length_df(rips_df, cons_df):
    ...
    def get_length(
        events_df_ss, base_phase_1, base_phase_2, tgt_bin_start=-2
    ):
        lengthes_all = []
        phases_all = []
...
def get_stats(df):
    ...
    for i_event, event in enumerate(["SWR", "Control"]):
