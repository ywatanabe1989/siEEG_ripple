#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Time-stamp: "2023-03-05 21:18:56 (ywatanabe)"
...
def corr_test(df_log10_g_dists):
    for i_pc, phase_combi in enumerate(["FE", "FM", "FR", "EM", "ER", "MR"]):
        print(phase_combi)
        out = mngs.stats.corr_test(df_log10_g_dists[phase_combi], df_log10_g_dists["set_size"])
...
if __name__ == "__main__":
    ...
    for match in [1,2]:
        ...
        # shuffled_corrs_all = corr_test(df_log10_g_dists, match)
