#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Time-stamp: "2022-12-28 09:31:02 (ywatanabe)"
import mngs
import sys
...
for ii, (_, trial) in enumerate(df.iterrows()):
    ...
    if ((before_session != current_session) and (ii != 0)) or (
        ii == len(df) - 1
    ):  # or (ii == 0): # :
        ...
        ax.plot(
            xx, yy, linestyle="--", color=colors_dict[before_subject]
        )  # xx, yy, "yo",
