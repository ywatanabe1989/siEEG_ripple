#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Time-stamp: "2022-12-10 00:24:17 (ywatanabe)"
...
def load_dist(suffix): # from_pkl=True
    ...
    dist_df_all = dist_df_all[dist_df_all.session.astype(int) <= SESSION_THRES]
    return dist_df_all

if __name__ == "__main__":
    dist_df = load_dist("cons")

    out = utils.dist.add_match_correct_response_time(dist_df)
