#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Time-stamp: "2023-01-13 13:19:30 (ywatanabe)"
...
if __name__ == "__main__":
    ...
    for lpath_traj in LPATHs_traj:
        if "transformed" not in lpath_traj:
            transformed_traj = main(lpath_traj)
            spath_transformed_traj = lpath_traj.replace("traj_", "traj_transformed_")
            mngs.io.save(transformed_traj, spath_transformed_traj)
